...
public class MainActivity extends AppCompatActivity {
    ...
    public void login() {
        ...
        Log.d("print", String.valueOf(username.equals("ilhamf")));
        Log.d("print", String.valueOf(password.equals("1197050087")));
        //Cek apakah username dan password benar
        if (username.equals("ilhamf") && password.equals("1197050087")) {
            Log.d("success", "Selamat Memesan");
